...
bool QBootstrap::programSoft(const QString &soft, QString &errorString)
{
    ...
    emit programProgressSignal(100, 50, TU("–‡ÒÔ‡ÍÓ‚Í‡ ÔÓ¯Ë‚ÍË ..."));
    ...
    emit programProgressSignal(100, 80, TU("œÓ‚ÂÍ‡ ..."));
    buildBootInfo();
    if(0>bootIndex)
    {
    ...
    emit programProgressSignal(100, 100, TU("«¿œ–Œ√–¿ÃÃ»–Œ¬¿ÕŒ ”—œ≈ÿÕŒ!"));
